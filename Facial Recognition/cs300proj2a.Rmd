...
#eigenvalue <- eigen(covariance)$values
#eigenvector <- eigen(covariance)$vectors
#pca <- princomp(t(newmatrix))
#pca <- prcomp(newmatrix)
...
#eigenvector <- covariance[,1:4] # k = 4
#eigenmatrix1 <-eigenvector[,1] * newmatrix
#eigenmatrix2 <-eigenvector[,2] * newmatrix
#eigenmatrix3 <-eigenvector[,3] * newmatrix
#eigenmatrix4 <-eigenvector[,4] * newmatrix
...
#heatmap(eigenpic1[1:50,],Rowv=NA,Colv=NA,col=grays, scale = "none")
